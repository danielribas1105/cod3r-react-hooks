...
export default function Maior() {
    ...
    return (
        <Pagina titulo="Maior" subtitulo="">
            <Display texto={`N1: ${n1} | N2: ${n2}`} textoComplementar={`O maior número é ${maior}`}/>
            <Flex gap={5}>
                <Botao redondo tamanho="2xl" texto="N1" cor="bg-red-500" onClick={() => setN1(n1 + 1)}/>
                <Botao redondo tamanho="2xl" texto="N2" cor="bg-blue-500" onClick={() => setN2(n2 + 1)}/>
            </Flex>
        </Pagina>
    )
}